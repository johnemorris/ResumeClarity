    ...
    <div className="space-y-12">
      ...
      <div className="relative bg-white rounded-[3.5rem] shadow-2xl border border-slate-100 p-12 md:p-16 flex flex-col lg:flex-row items-stretch gap-16 overflow-hidden">
          ...
          <div className="flex-1 space-y-6 w-full max-w-sm">
             <div className="space-y-2">
                <div className="flex justify-between items-end">
                   <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Core Technical Skills</div>
             ...
             <div className="space-y-2">
                <div className="flex justify-between items-end">
                   <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Professional Qualities</div>
             ...
             <div className="space-y-2">
                <div className="flex justify-between items-end">
                   <div className="text-[9px] font-black text-slate-400 uppercase tracking-widest">Industry Language</div>
        ...
        <div className="lg:w-1/3 flex flex-col gap-4">
          <div className="flex-1 bg-slate-950 text-white p-8 rounded-[2rem] shadow-2xl relative overflow-hidden group cursor-pointer" onClick={fetchTraps}>
          ...
          <div className="flex-1 bg-indigo-600 text-white p-8 rounded-[2rem] shadow-2xl relative overflow-hidden group cursor-pointer" onClick={fetchPathways}>
             <div className="relative z-10 space-y-2">
      ...
      {/* Main Forensic Table */}
      <div className={`bg-white rounded-[2.5rem] shadow-2xl border border-slate-100 overflow-hidden transition-all duration-700 ${showHeatmap ? 'ring-4 ring-rose-100' : ''}`}>
        ...
        <div className="flex items-center justify-between border-b border-slate-100 bg-slate-50/50 px-6 py-3">
          <div className="flex gap-2 p-1 bg-slate-200/40 rounded-xl">
            {(['all', 'missing', 'present', 'phrases'] as const).map(tab => (
              ...
              >
                {tab === 'all' ? 'All' : tab === 'missing' ? 'Gaps' : tab === 'present' ? 'Wins' : 'Language'}
              </button>
            ))}
          </div>
